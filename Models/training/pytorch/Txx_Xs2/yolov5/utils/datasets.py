...
def box_candidates(box1, box2, wh_thr=10, ar_thr=30, area_thr=0.5, eps=1e-16):  # box1(4,n), box2(4,n) #yrjiao
...
def verify_image_label(args):
    ...
    try:
        # verify images
        if "sun_dzynzduheoqxbend.jpg" in im_file:
           print(im_file)	
