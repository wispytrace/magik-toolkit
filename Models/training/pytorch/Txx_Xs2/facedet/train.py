...
from vision_quantize.datasets.voc_dataset import VOCDataset
from vision_quantize.nn.multibox_loss import MultiboxLoss
from vision_quantize.ssd.config.fd_config import define_img_size
from vision_quantize.utils.misc import str2bool, Timer, freeze_net_layers, store_labels
...
parser.add_argument('--optimizer_type', default="SGD", type=str,
                    help='optimizer_type')
parser.add_argument('--pretraine_net', default="", type=str,
                    help='pretrain_net all')
...
from vision_quantize.ssd.config import fd_config
from vision_quantize.ssd.data_preprocessing import TrainAugmentation, TestTransform
from vision_quantize.ssd.mb_tiny_fd import create_mb_tiny_fd
from vision_quantize.ssd.ssd import MatchPrior

DEVICE = torch.device(f"cuda:{args.cuda_index}" if torch.cuda.is_available() and args.use_cuda else "cpu")
...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        net.module.init_from_pretrained_ssd(args.pretrained_ssd)
