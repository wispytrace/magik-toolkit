...
from vision_quantize.utils.box_utils import generate_priors

#image_mean_test = image_mean = np.array([127, 127, 127]) 
image_mean_test = image_mean = 128 #sfyan change ori 127
image_std = 128.0
iou_threshold = 0.3
center_variance = 0.1
size_variance = 0.2

min_boxes = [[10, 16, 24], [32, 48], [64, 96], [128, 192, 256]] #ori
#min_boxes = [[11,16,24,32], [40,48], [64,96], [128, 192,256]]
